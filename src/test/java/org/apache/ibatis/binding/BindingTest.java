...
public class BindingTest {
    ...
    public void shouldSelectBlogWithPostsUsingSubSelect() {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            System.out.println("查询到的结果：" + blog);
            assertEquals(1, blog.getId());
            assertNotNull(blog.getAuthor());
            assertEquals(101, blog.getAuthor().getId());
            assertEquals("jim", blog.getAuthor().getUsername());
            assertEquals("********", blog.getAuthor().getPassword());
    ...
    public void shouldSelectOneBlogAsMap() {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            blog.forEach((k, v) -> System.out.println("key：" + k + " <=====> value：" + v));
    ...
    public void shouldSelectOneAuthorFromCache() {
        ...
        System.out.println("结果：" + (author1 == author2));
    ...
    public void registeredMappers() {
        ...
        System.out.println("结果：" + mapperClasses.size());
        mapperClasses.forEach(System.out::println);
